    ...
    <nav className="fixed top-0 left-0 w-full bg-white z-10">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <Link href="/about" className="hover:text-purple-600">เกี่ยวกับฉัน</Link>
          <Link href="/history" className="hover:text-purple-600">ประวัติ</Link>
          <Link href="/skills" className="hover:text-purple-600">ความสามารถ</Link>
          <Link href="/work" className="hover:text-purple-600">ผลงาน</Link>
